...
namespace EF11.EntityFrameworkCoreMigration2.Data.Config
{
    ...
    public class ScheduleConfiguration : IEntityTypeConfiguration<Schedule>
    {
        public void Configure(EntityTypeBuilder<Schedule> builder)
        {
            ...
            builder.Property(X => X.SUN).HasColumnType("BIT");
            builder.Property(X => X.MON).HasColumnType("BIT");
            builder.Property(X => X.TUE).HasColumnType("BIT");
            builder.Property(X => X.WED).HasColumnType("BIT");
            builder.Property(X => X.THU).HasColumnType("BIT");
            builder.Property(X => X.FRI).HasColumnType("BIT");
            builder.Property(X => X.SAT).HasColumnType("BIT");
        ...
        private static Schedule[] LoadSchedules()
        {
            return new[]
            {
                new Schedule { Id = 1, Title = "Daily", SUN = true, MON = true, TUE = true, WED = true, THU = true, FRI = true, SAT = true },
                new Schedule { Id = 2, Title = "Weekdays", SUN = false, MON = true, TUE = true, WED = true, THU = true, FRI = true, SAT = false },
                new Schedule { Id = 3, Title = "Weekend", SUN = true, MON = false, TUE = false, WED = false, THU = false, FRI = false, SAT = true },
                new Schedule { Id = 4, Title = "MondayWednesdayFriday", SUN = false, MON = true, TUE = false, WED = true, THU = false, FRI = true, SAT = false },
                new Schedule { Id = 5, Title = "TuesdayThursday", SUN = false, MON = false, TUE = true, WED = false, THU = true, FRI = false, SAT = false }
            };
        }
    }
